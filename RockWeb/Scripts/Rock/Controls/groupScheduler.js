        ...
        var exports = {
            ...
            populateScheduledOccurrence: function($occurrence) {
                ...
                $.get(
                    ...
                    function(scheduledAttendanceItems) {
                        ...
                        $schedulingStatusContainer.tooltip({
                            html: 'true',
                            container: 'body',
                        });
                        ...
                        var declinedPercent =
                            !progressMax || (totalDeclined * 100) / progressMax;
                        var minimumPercent =
                            !progressMax ||
                        ...
                        var $progressDeclined = $schedulingStatusContainer.find(
                            '.js-scheduling-progress-declined',
                        );
            ...
            populateResourceDiv: function(
                ...
                if (schedulerResource.ConflictNote) {
                    $resourceDiv
                        .find('.js-resource-warning')
                        .text(schedulerResource.ConflictNote);
                }

                if (schedulerResource.LastAttendanceDateTime) {
                    var $lastAttendedDate = $resourceDiv.find(
                        '.js-resource-lastattendeddate',
                    );
                    $lastAttendedDate.attr(
                        'data-datetime',
