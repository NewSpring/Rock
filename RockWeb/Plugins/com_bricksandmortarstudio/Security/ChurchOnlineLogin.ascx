<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChurchOnlineLogin.ascx.cs" Inherits="RockWeb.Plugins.com_bricksandmortarstudio.Security.ChurchOnlineLogin" %>
